...
The `mediaActions` tool provides four operations:

### storeMediaFile

Upload audio to Anki from three sources:
...
Download audio from Anki as base64:
...
```javascript
{
  ...
  pattern: "spanish_*.mp3"  // optional glob pattern
}
```

### deleteMediaFile

Remove audio file from Anki:
