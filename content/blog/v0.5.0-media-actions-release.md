...
If this pattern works well, it may be applied to other tool groups (model management, note operations, etc.).

Feedback on the unified tool pattern can be submitted through the [Community & Support](/about/#community--support) channels.
...
→ [Download v0.5.0](https://github.com/ankimcp/anki-mcp-server/releases/download/v0.5.0/anki-mcp-server-0.5.0.mcpb)
...
Feature requests can be submitted through the [Community & Support](/about/#community--support) channels.
...
**Full Changelog:** [v0.5.0 on GitHub](https://github.com/ankimcp/anki-mcp-server/releases/tag/v0.5.0)
