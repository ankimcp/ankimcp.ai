...
**Your feedback matters!** Let us know which approach you prefer in our discussions.
...
→ [Download v0.5.0](https://github.com/anki-mcp/anki-mcp-desktop/releases/download/v0.5.0/anki-mcp-http-0.5.0.mcpb)
...
We're excited about the possibilities this opens up:

- Video/GIF support for visual learners
- Batch media operations
- Media compression and optimization
- Integration with more TTS providers
- Community-contributed voice collections
