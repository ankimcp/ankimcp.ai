...
→ [Download from Releases](https://github.com/ankimcp/anki-mcp-server/releases)
...
- [GitHub Repository](https://github.com/ankimcp/anki-mcp-server) - Source code and documentation
- [Full Changelog](https://github.com/ankimcp/anki-mcp-server/releases/tag/v0.8.0) - Complete list of changes

Happy learning from anywhere! 📚🌐

---

**Full Changelog:** [v0.8.0 on GitHub](https://github.com/ankimcp/anki-mcp-server/releases/tag/v0.8.0)
