...
→ [Download v0.6.0](https://github.com/ankimcp/anki-mcp-server/releases/download/v0.6.0/anki-mcp-server-0.6.0.mcpb)
...
```bash
npx @ankimcp/anki-mcp-server@latest
```
...
**Full Changelog:** [v0.6.0 on GitHub](https://github.com/ankimcp/anki-mcp-server/releases/tag/v0.6.0)
